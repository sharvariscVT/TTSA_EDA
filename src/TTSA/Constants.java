...
//This class consists of all the parameter values used in TTSA
    static Double theta =  1.04;
    static int T = 400;
    static double sigma = 1.04;
    static double beta = 0.998;
    static int maxP =10;
    static int maxR = 10;
    static int maxC = 100;
    static double w = 9000;




    public static int[][] getDistance4() {
        return distance4;
    }

    public static int[][] getDistance6() {
        return distance6;
    }

    public static int[][] getDistances10() {
        return distances10;
    }

    public static int[][] getDistances12() {
        return distances12;
    }

    public static int[][] getDistances14() {
        return distances14;
    }

    public static int[][] getDistances16() {
        return distances16;
    }
   ...
   static int[][] distances10= {
           {0,  745,  665,  929,  605,  521,  370,  587,  467,  670},
   ...
   static int[][] distances12 = {
           {0 , 745,  665 , 929,  605,  521,  370,  587,  467,  670,  700, 1210},
...
static int[][] distances14 = {
        {0,  745,  665,  929,  605,  521,  370,  587,  467,  670,  700, 1210, 2130, 1890},
        {745,   0,   80,  337, 1090,  315,  567,  712,  871,  741, 1420, 1630, 2560, 2430},
        {665,  80,    0,  380, 1020,  257,  501,  664,  808,  697, 1340, 1570, 2520, 2370},
        {929, 337 , 380  ,  0 ,1380,  408,  622,  646 , 878 , 732, 1520, 1530, 2430, 2360},
        {605, 1090, 1020, 1380,   0, 1010,  957, 1190, 1060, 1270,  966, 1720, 2590, 2270},
        {521 , 315,  257 , 408, 1010 ,  0 , 253 , 410,  557,  451, 1140, 1320, 2260, 2110},
        {370 , 567 , 501 , 622 , 957 , 253 ,  0 , 250 , 311 , 325 , 897, 1090 ,2040 ,1870},
        {587,  712 , 664 , 646, 1190 , 410 , 250 ,  0 , 260,   86,  939,  916, 1850, 1730},
        {467,  871,  808,  878, 1060,  557,  311,  260 ,  0,  328,  679,  794, 1740, 1560},
        {670  ,741,  697,  732, 1270 , 451 , 325 ,  86 ,328 ,   0, 1005,  905, 1846, 1731},
        {700, 1420, 1340, 1520,  966 ,1140 , 897 , 939 , 679, 1005 ,  0,  878 ,1640 ,1300},
        {1210, 1630 ,1570, 1530 ,1720 ,1320, 1090,  916 , 794,  905 , 878 ,  0 , 947 , 832},
        {2130 ,2560 ,2520 ,2430, 2590, 2260, 2040, 1850, 1740, 1846 ,1640 ,947 ,  0 , 458},
        {1890, 2430, 2370, 2360, 2270, 2110 ,1870 ,1730 ,1560 ,1731 ,1300 ,832 , 458 ,  0}
